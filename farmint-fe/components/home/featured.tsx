...
import { LazyBannerImage, LazyAvatarImage } from "@/components/ui/lazy-image";
...
export function Featured() {
  ...
  return (
    <section className="pt-2">
      ...
      <div className="relative overflow-hidden rounded-xl aspect-[4/3] w-full gradient-border smooth-120 hover:-translate-y-1 hover:shadow-glow-md">
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between mt-2">
              <div className="flex flex-col">
                ...
                <span className="text-body-md font-medium">{formatPrice(currentNFT.price)} ETH</span>
              </div>
              ...
              <Button
                ...
                className="button-smooth hover:scale-105 hover:shadow-glow-lg"
              >
                <span className="smooth-120">View NFT</span>
              </Button>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-4 right-4 flex gap-1 z-20">
          {featuredNFTs.map((_, index) => (
            <button
              key={index}
              className={cn(
                "h-1.5 rounded-full smooth-120 hover:scale-110 active:scale-95",
                index === currentIndex ? "w-6 bg-primary-500 shadow-glow-sm" : "w-1.5 bg-neutral-600 hover:bg-neutral-500"
              )}
